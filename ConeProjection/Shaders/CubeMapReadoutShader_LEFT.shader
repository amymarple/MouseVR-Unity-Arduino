Shader "Unlit/CubeMapReadoutShader_LEFT"
{
    Properties
    {
        _MainTex("NormalMap", 2D) = "white" {}
		_Cube("CubeMap", Cube) = "white" {}
        _MousePositionLEFT("MousePositionLEFT", Vector) = (0, 0, -3, 0)
        _AlignmentImageLEFT("AlignmentImageLEFT", Range(0, 1)) = 0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _MainTex_ST;
            float4 _MousePositionLEFT;
            float _AlignmentImageLEFT;
            float _MaxHeight;
            float _MinHeight;
            float _fadeOut;
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float3 normal_for_cubemap = normalize(X - _MousePositionLEFT.xyz);
                ...
                float alph = saturate(_AlignmentImageLEFT);
